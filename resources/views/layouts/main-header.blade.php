							...
							<div class="dropdown nav-item main-header-message ">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">رسال البريد الكتوني</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">من </span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك 4 رساله غير مقرواه</p>
									</div>
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">وافي اليوسفي</h5>
												</div>
												<p class="mb-0 desc">تم تاكيد حجزك</p>
