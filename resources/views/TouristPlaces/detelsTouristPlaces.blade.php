...
@endif
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
                                <?php $i = 0; ?>
                                @foreach ($detelsTouristPlaces as $addhotel)
                                    <?php $i++; ?>
                                        <td>{{ $i }}</td>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('detelsTouristPlaces.store') }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
                   
                    
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">شرح المكان السياحي</label>
                        ...
                        <div class="form-group">
                                ...
                                <select name="contentourist" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد تابع المكان السياحي</option>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="detelsTouristPlaces/update" method="post" autocomplete="off">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">شرح المكان السياحي</label>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1"> معلوات رحله المكان السياحي</label>
                            <textarea class="form-control" id="informationtrip" name="informationtrip" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">موقع المكان السياحي</label>
                            <textarea class="form-control" id="location" name="location" rows="3"></textarea>
                        </div>	
                        <div class="form-group">
                         <label for="image">صور المكان</label>
