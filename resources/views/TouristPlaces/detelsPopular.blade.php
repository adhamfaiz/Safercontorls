...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">اضافه</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تفاصيل اماكن رائجه</span>
						</div>
					</div>
...
@endif
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافه تفاصيل اماكن رائجه </a>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
                                <?php $i = 0; ?>
                                @foreach ($detels_populer as $addhotel)
                                    <?php $i++; ?>
                                        <td>{{ $i }}</td>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">اضافه تفاصيل المكان الرائج</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
                    <form action="{{ route('detels_populer.store') }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
                   
                    
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">شرح المكان الرئج</label>
                        ...
                        <div class="form-group">
                                ...
                                <select name="contentourist" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد تابع المكان الرائج</option>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل الاماكن الرائجه</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="detels_populer/update" method="post" autocomplete="off">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">شرح المكان الرئج</label>
                        ...
                        <div class="form-group">
                                ...
                                <select name="contentourist" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد تابع المكان الرئج</option>
                                    @foreach ($Popular as $addhotel)
                                        <option value="{{ $addhotel->location }}"> {{ $addhotel->location }}</option>
                                    @endforeach
                                </select>
                            </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1"> معلوات رحله المكان الرئج</label>
                            <textarea class="form-control" id="informationtrip" name="informationtrip" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">موقع المكان الرئج</label>
                            <textarea class="form-control" id="location" name="location" rows="3"></textarea>
                        </div>	
                        <div class="form-group">
                         <label for="image">صور المكان</label>
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف المكان الرائج</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="detels_populer/destroy" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
